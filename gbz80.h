...
typedef struct
{
        clock_type clock; // 14 bytes aligned to 8
        struct
        {
                union
                {
...
void LD_A_C_t(void);
void LD_C_A_t(void);
void LDD_A_HL_t(void);
void LDD_HL_A_t(void);
void LDI_A_HL_t(void);
void LDI_HL_A_t(void);
void LDH_n_A_t(void);
void LDH_A_n_t(void);
